...
$$.Closure$0 = [F, {"": "Closure;call$0,$name"}];

$$.Closure$1 = [F, {"": "Closure;call$1,$name", $is_args1: true}];
...
["Kingdom", "main.dart", , F, {
ImageLoader_loadImages: function() {
  var futures, t1, filename, elemeno, t2, t3;
  futures = P.List_List(null, null);
  for (t1 = new H.ListIterator($.get$ImageLoader_filenames(), 11, 0, null); t1.moveNext$0();) {
    filename = t1._current;
    elemeno = W.ImageElement_ImageElement(null, null, null);
    t2 = J.getInterceptor$x(elemeno);
    t2.set$src(elemeno, C.JSString_methods.$add("assets/", filename));
    t3 = $.get$ImageLoader_images();
    t3.$indexSet(t3, filename, elemeno);
    t2 = t2.get$onLoad(elemeno);
    futures.push(t2.get$first(t2));
  }
...
main: function() {
  ...
  t1 = $.context;
  t1.fillStyle = "blue";
  t1.fillRect(0, 0, $.width, $.height);
  F.ImageLoader_loadImages().then$1(new F.main_closure()).then$1(new F.main_closure0()).then$1(new F.main_closure1());
},

gameLoop: function(time) {
  var delta, t1, t2, t3;
  delta = J.$sub$n(time, $.lastTime);
  $.lastTime = time;
  t1 = $.context;
  t1.fillStyle = "black";
  t1.fillRect(0, 0, $.width, $.height);
  ...
  t3 = t1._frame;
  t3.context = t2;
  t1._handleInput$1(delta);
  t1._map.draw$3(t3, t1.selectedUnit, t1._tempOrderPath);
  C.Window_methods.get$animationFrame(window).then$1(F.gameLoop$closure);
},

FileMapGenerator: {"": "MapLoader;_mapWidth,_mapHeight,_data",
  FileMapGenerator$1: function(data) {
    var lines, t1, line, t2, key, val, dataStart, i, nums, num;
    window;
    ...
    this._mapWidth = -1;
    this._mapHeight = -1;
    lines = J.replaceAll$2$s(data, "\r", "").split("\n");
    for (t1 = new H.ListIterator(lines, lines.length, 0, null); t1.moveNext$0();) {
      line = t1._current;
      t2 = H.JSSyntaxRegExp_makeNative("^[a-zA-Z]+=.+$", false, true, false);
      if (typeof line !== "string")
        H.throwExpression(new P.ArgumentError(line));
      if (new H.JSSyntaxRegExp(t2, null, null)._nativeRegExp.test(line)) {
        t2 = J.split$1$s(line, "=");
        if (0 >= t2.length)
          throw H.ioore(t2, 0);
        key = t2[0];
        ...
        if (t2.$eq(key, "width"))
          this._mapWidth = H.Primitives_parseInt(val, null, null);
        if (t2.$eq(key, "height"))
          this._mapHeight = H.Primitives_parseInt(val, null, null);
      }
    }
    t1 = P.List_List(null, J.JSInt);
    H.setRuntimeTypeInfo(t1, [J.JSInt]);
    this._data = t1;
    for (dataStart = 0, i = 0; i < lines.length; ++i)
      if (J.indexOf$1$asx(lines[i], "data") === 0)
        dataStart = i;
    window;
    $.get$Console__safeConsole().toString;
    if (typeof console != "undefined")
      console.log("----------DATA--------");
    for (i = dataStart + 1; t1 = lines.length, i < t1; ++i) {
      if (i < 0)
        throw H.ioore(lines, i);
      nums = J.split$1$s(lines[i], ",");
      for (t1 = new H.ListIterator(nums, nums.length, 0, null); t1.moveNext$0();) {
        num = t1._current;
        t2 = H.JSSyntaxRegExp_makeNative("[0-9]", false, true, false);
        if (typeof num !== "string")
          H.throwExpression(new P.ArgumentError(num));
        if (new H.JSSyntaxRegExp(t2, null, null)._nativeRegExp.test(num))
          this._data.push(H.Primitives_parseInt(num, null, null));
      }
    }
    window;
    $.get$Console__safeConsole().toString;
  ...
  static: {
FileMapGenerator$: function(data) {
  var t1 = new F.FileMapGenerator(null, null, null);
  t1.FileMapGenerator$1(data);
  return t1;
}}

},

Frame: {"": "Object;scrollX,scrollY,scale,context",
  scrollTo$1: function(_, zoomLevel) {
    this.scale = Math.pow(2, (zoomLevel + 1) * 0.15);
    this.scale = C.JSNumber_methods.toInt$0(Math.floor(this.scale * 64)) / 64;
  }
},

Keyboard: {"": "Object;_wheel,_keyMap,_clickHappened,_rClickHappened,_clickX,_clickY,_rClickX,_rClickY,_x,_y,rDown",
  get$x: function(_) {
    return this._x;
  },
  get$y: function(_) {
  ...
  isKeyDown$1: function(code) {
    var t1 = this._keyMap;
    if (t1.containsKey$1(code))
  ...
  Keyboard$0: function() {
    ...
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.Keyboard_closure(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = C.EventStreamProvider_keyup.forTarget$1(window);
    t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.Keyboard_closure0(this)), t2._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t1._tryResume$0();
    t1 = C._CustomEventStreamProvider__determineMouseWheelEventType.forTarget$1(window);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.Keyboard_closure1(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = $.context.canvas;
    t2.toString;
    t2 = C.EventStreamProvider_mousedown.forElement$1(t2);
    t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.Keyboard_closure2(this)), t2._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t1._tryResume$0();
    t1 = $.context.canvas;
    t1.toString;
    t1 = C.EventStreamProvider_mouseup.forElement$1(t1);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.Keyboard_closure3(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = $.context.canvas;
    t2.toString;
    t2 = C.EventStreamProvider_click.forElement$1(t2);
    t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.Keyboard_closure4(this)), t2._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t1._tryResume$0();
    t1 = $.context.canvas;
    t1.toString;
    t1 = C.EventStreamProvider_contextmenu.forElement$1(t1);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.Keyboard_closure5(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = $.context.canvas;
    t2.toString;
    t2 = C.EventStreamProvider_mousemove.forElement$1(t2);
    t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.Keyboard_closure6(this)), t2._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t1._tryResume$0();
  },
  static: {
Keyboard$: function() {
  var t1 = new F.Keyboard(1, H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), false, false, -1, -1, -1, -1, -1, -1, false);
  t1.Keyboard$0();
  return t1;
}}
...
Keyboard_closure: {"": "Closure;this_0",
  call$1: function(e) {
    var t1 = this.this_0._keyMap;
    t1.$indexSet(t1, J.get$keyCode$x(e), true);
  },
  $is_args1: true
},
...
Keyboard_closure0: {"": "Closure;this_1",
  call$1: function(e) {
    var t1 = this.this_1._keyMap;
    t1.$indexSet(t1, J.get$keyCode$x(e), false);
  },
  $is_args1: true
},

Keyboard_closure1: {"": "Closure;this_2",
  call$1: function(e) {
    var t1 = this.this_2;
    t1._wheel = t1._wheel + C.JSInt_methods.$tdiv(J.toInt$0$n(J.get$deltaY$x(e)), -100);
  },
  $is_args1: true
},

Keyboard_closure2: {"": "Closure;this_3",
  call$1: function(e) {
    if (J.get$button$x(e) === 2) {
      window;
      $.get$Console__safeConsole().toString;
      if (typeof console != "undefined")
        console.log("moseDoun");
      this.this_3.rDown = true;
    }
  },
  $is_args1: true
},

Keyboard_closure3: {"": "Closure;this_4",
  call$1: function(e) {
    if (J.get$button$x(e) === 2) {
      window;
      $.get$Console__safeConsole().toString;
      if (typeof console != "undefined")
        console.log("moseUp");
      this.this_4.rDown = false;
    }
  },
  $is_args1: true
},

Keyboard_closure4: {"": "Closure;this_5",
  call$1: function(e) {
    var t1, t2;
    t1 = J.getInterceptor$x(e);
    if (t1.get$button(e) === 0) {
      t2 = this.this_5;
      t2._clickHappened = true;
      t2._clickX = t1.get$offset(e).x;
      t2._clickY = t1.get$offset(e).y;
    } else if (e.button === 1)
      ;
  },
  $is_args1: true
...
Keyboard_closure5: {"": "Closure;this_6",
  call$1: function(e) {
    var t1, t2;
    t1 = J.getInterceptor$x(e);
    t1.preventDefault$0(e);
    t2 = this.this_6;
    t2._rClickHappened = true;
    t2._rClickX = t1.get$offset(e).x;
    t2._rClickY = t1.get$offset(e).y;
  },
  $is_args1: true
},

Keyboard_closure6: {"": "Closure;this_7",
  call$1: function(e) {
    var t1, t2, t3;
    t1 = this.this_7;
...
King: {"": "Unit;tileX,tileY,offsetX,offsetY,myImagePlayerSufix,myImagePlayerPrefix,tilesPerTurn,timePerTile,tilesMovedAlready,msAlreadyAnimated,currentUnitTurnState,orders,currentOrder,currentMovingToPoint,_player"},

MapLoader: {"": "Object;"},

Order: {"": "Object;_waypoints,_turnsTillExecute,_map,activated",
  aStar$2: function(from, to) {
    var $parent, closedSet, openSet, initialNode, t1, current, it, result, resultNode, curX, curY, y, y0, x, x0, dir, y1, x1, neighbor, t2, possiblePastScore, possibleTotalScore;
    $parent = P.LinkedHashMap_LinkedHashMap(null, null, null, F.PathfindingNode, F.PathfindingNode);
    closedSet = P.LinkedHashSet_LinkedHashSet(null, null, null, F.PathfindingNode);
    openSet = P.LinkedHashSet_LinkedHashSet(null, null, null, F.PathfindingNode);
    initialNode = F.PathfindingNode$withCordinates(from._x, from._y);
    initialNode.pastScore = 0;
    initialNode.totalScore = initialNode.distanceTo$1(to);
    initialNode.scored = true;
    openSet.add$1(openSet, initialNode);
    for (; openSet._length > 0;) {
      t1 = openSet._first;
      if (t1 == null)
        H.throwExpression(P.StateError$("No elements"));
      current = t1.get$_element();
      for (t1 = new P.LinkedHashSetIterator(openSet, openSet._modifications, null, null), t1._cell = t1._set._first; t1.moveNext$0();) {
        it = t1._collection$_current;
        if (it.totalScore < current.totalScore)
          current = it;
      }
      t1 = current._waypoint;
      if (t1._x === to._x && t1._y === to._y) {
        result = P.List_List(null, F.WayPoint);
        result.$builtinTypeInfo = [F.WayPoint];
        for (resultNode = current; t1 = resultNode.get$waypoint(), !t1.$eq(t1, from);) {
          C.JSArray_methods.insert$2(result, 0, resultNode._waypoint);
          resultNode = $parent.$index($parent, resultNode);
        }
        return result;
      }
      openSet.remove$1(openSet, current);
      closedSet.add$1(closedSet, current);
      t1 = current._waypoint;
      curX = t1._x;
      curY = t1._y;
      for (y = curY + 1, y0 = curY - 1, x = curX + 1, x0 = curX - 1, dir = 0; dir < 4; ++dir) {
        if (dir === 0) {
          y1 = curY;
          x1 = x0;
        } else if (dir === 1) {
        ...
        neighbor = new F.PathfindingNode(null, false, -1, -1);
        neighbor.scored = false;
        neighbor.totalScore = -1;
        neighbor.pastScore = -1;
        neighbor._waypoint = new F.WayPoint(x1, y1);
        if (!(x1 === curX && y1 === curY))
          if (x1 >= 0) {
            t1 = this._map;
            t2 = t1._mapW;
            ...
            if (x1 < t2)
              if (y1 >= 0) {
                ...
                if (typeof t1 !== "number")
                  throw H.iae(t1);
                if (y1 < t1)
                  if (!closedSet.contains$1(closedSet, neighbor)) {
                    t1 = this._map;
                    t2 = t1._mapData;
                    t1 = t1._mapW;
                    if (typeof t1 !== "number")
                    ...
                    if (t1 >>> 0 !== t1 || t1 >= t2.length)
                      throw H.ioore(t2, t1);
                    t1 = J.$eq(t2[t1], 1) && this._map.unitAt$2(x1, y1) == null;
                  } else
                    t1 = false;
                else
                  t1 = false;
          ...
          t1 = false;
        if (t1) {
          possiblePastScore = current.pastScore + 1;
          possibleTotalScore = possiblePastScore + (Math.abs(neighbor._waypoint._x - to._x) + Math.abs(neighbor._waypoint._y - to._y));
          if (!openSet.contains$1(openSet, neighbor) || possibleTotalScore < neighbor.totalScore) {
            $parent.$indexSet($parent, neighbor, current);
            neighbor.pastScore = possiblePastScore;
            neighbor.totalScore = possibleTotalScore;
            if (!openSet.contains$1(openSet, neighbor))
              openSet.add$1(openSet, neighbor);
          }
        }
      }
    }
...
PathfindingNode: {"": "Object;_waypoint,scored,totalScore,pastScore",
  get$waypoint: function() {
    return this._waypoint;
  },
  distanceTo$1: function(pt) {
    return Math.abs(this._waypoint._x - pt._x) + Math.abs(this._waypoint._y - pt._y);
  },
  $eq: function(_, comp) {
    var t1;
    if (comp == null)
      return false;
    t1 = this._waypoint;
    return t1._x === comp.get$waypoint()._x && t1._y === comp._waypoint._y;
  },
  $lt: function(_, comp) {
    var t1, t2;
    t1 = this._waypoint._y;
    t2 = comp.get$waypoint();
    if (C.JSInt_methods.$lt(t1, t2.get$y(t2)))
      return true;
    else {
      t1 = this._waypoint._y;
      t2 = comp.get$waypoint();
      if (C.JSInt_methods.$gt(t1, t2.get$y(t2)))
        return false;
      else {
        t1 = this._waypoint._x;
        t2 = comp.get$waypoint();
        if (C.JSInt_methods.$lt(t1, t2.get$x(t2)))
          return true;
        else
          return false;
      }
  ...
  PathfindingNode$withCordinates$2: function($X, $Y) {
    this.scored = false;
    this.totalScore = -1;
    this.pastScore = -1;
    this._waypoint = new F.WayPoint($X, $Y);
  },
  static: {
PathfindingNode$withCordinates: function($X, $Y) {
  var t1 = new F.PathfindingNode(null, false, -1, -1);
  t1.PathfindingNode$withCordinates$2($X, $Y);
  return t1;
}}
...
TileMap: {"": "Object;_mapW,_mapH,_mapData,_mapObjects,_selectedTex,_waypointTex,_waypointChooserTex,_pathfindingTex,_tileset",
  draw$3: function(frame, selectedUnit, path) {
    var t1, t2, minTileX, maxTileX, minTileY, maxTileY, x, y, srcRect, t3, t4, destRect, drawingUnit, wp, t5, t6;
    t1 = frame.scrollX;
    t2 = frame.context.canvas.width;
    if (typeof t2 !== "number")
      throw t2.$div();
    minTileX = C.JSNumber_methods.toInt$0(P.max(t1 - t2 / 2 / frame.scale / 64, 0));
    t2 = frame.scrollX;
    t1 = frame.context.canvas.width;
    if (typeof t1 !== "number")
      throw t1.$div();
    maxTileX = C.JSNumber_methods.toInt$0(P.min(t2 + t1 / 2 / frame.scale / 64 + 1, J.$sub$n(this._mapW, 1)));
    t1 = frame.scrollY;
    t2 = frame.context.canvas.height;
    if (typeof t2 !== "number")
      throw t2.$div();
    minTileY = C.JSNumber_methods.toInt$0(P.max(t1 - t2 / 2 / frame.scale / 64, 0));
    t2 = frame.scrollY;
    t1 = frame.context.canvas.height;
    if (typeof t1 !== "number")
      throw t1.$div();
    maxTileY = C.JSNumber_methods.toInt$0(P.min(t2 + t1 / 2 / frame.scale / 64 + 1, J.$sub$n(this._mapH, 1)));
    for (x = minTileX; x <= maxTileX; ++x)
      for (y = minTileY; y <= maxTileY; ++y) {
        ...
        if (t2 >>> 0 !== t2 || t2 >= t1.length)
          throw H.ioore(t1, t2);
        srcRect = new P.Rectangle(J.$mul$n(J.$sub$n(t1[t2], 1), 64), 0, 64, 64);
        srcRect.$builtinTypeInfo = [J.JSInt];
        t1 = frame.scrollX;
        t2 = frame.scale;
        t3 = frame.context.canvas.width;
        if (typeof t3 !== "number")
          throw t3.$div();
        t3 = C.JSNumber_methods.toInt$0((x - t1) * 64 * t2 + t3 / 2);
        t2 = frame.scrollY;
        t1 = frame.scale;
        t4 = frame.context.canvas.height;
        if (typeof t4 !== "number")
          throw t4.$div();
        destRect = new P.Rectangle(t3, C.JSNumber_methods.toInt$0((y - t2) * 64 * t1 + t4 / 2), C.JSNumber_methods.toInt$0(64 * frame.scale), C.JSNumber_methods.toInt$0(64 * frame.scale));
        destRect.$builtinTypeInfo = [J.JSInt];
        J.drawImageToRect$3$sourceRect$x(frame.context, this._tileset, destRect, srcRect);
      }
    for (x = minTileX; x <= maxTileX; ++x)
      for (y = minTileY; y <= maxTileY; ++y) {
        t1 = frame.scrollX;
        ...
        destRect = new P.Rectangle(t3, C.JSNumber_methods.toInt$0((y - t2) * 64 * t1 + t4 / 2), C.JSNumber_methods.toInt$0(64 * frame.scale), C.JSNumber_methods.toInt$0(64 * frame.scale));
        destRect.$builtinTypeInfo = [J.JSInt];
        drawingUnit = this.unitAt$2(x, y);
        if (drawingUnit != null) {
          t1 = J.toInt$0$n(J.$add$ns(destRect.left, drawingUnit.offsetX * frame.scale));
          t2 = destRect.top;
          t3 = drawingUnit.offsetY;
          t4 = frame.scale;
          if (typeof t2 !== "number")
            throw t2.$add();
          t4 = C.JSNumber_methods.toInt$0(t2 + t3 * t4);
          t3 = C.JSNumber_methods.toInt$0(64 * frame.scale);
          t2 = C.JSNumber_methods.toInt$0(64 * frame.scale);
          new P.Rectangle(t1, t4, t3, t2).$builtinTypeInfo = [J.JSInt];
          if (drawingUnit == null ? selectedUnit == null : drawingUnit === selectedUnit) {
            t1 = frame.context;
            t2 = $.get$ImageLoader_images();
            J.drawImageToRect$2$x(t1, t2.$index(t2, "selected.png"), destRect);
          }
          t1 = frame.context;
          t2 = $.get$ImageLoader_images();
          J.drawImageToRect$2$x(t1, t2.$index(t2, J.$add$ns(drawingUnit.myImagePlayerPrefix, drawingUnit.myImagePlayerSufix) + ".png"), destRect);
        }
      }
    if (path != null) {
      window;
      ...
      for (t1 = new H.ListIterator(path, path.length, 0, null); t1.moveNext$0();) {
        wp = t1._current;
        t2 = J.getInterceptor$x(wp);
        if (J.$ge$n(t2.get$x(wp), minTileX))
          if (J.$le$n(t2.get$x(wp), maxTileX)) {
            t3 = t2.get$y(wp);
            if (typeof t3 !== "number")
              throw t3.$ge();
            if (t3 >= minTileY) {
          ...
          t3 = false;
        if (t3) {
          t3 = J.$mul$n(J.$mul$n(J.$sub$n(t2.get$x(wp), frame.scrollX), 64), frame.scale);
          t4 = frame.context.canvas.width;
          if (typeof t4 !== "number")
            throw t4.$div();
          t4 = J.toInt$0$n(J.$add$ns(t3, t4 / 2));
          t2 = t2.get$y(wp);
          t3 = frame.scrollY;
          if (typeof t2 !== "number")
            throw t2.$sub();
          t5 = frame.scale;
          t6 = frame.context.canvas.height;
          if (typeof t6 !== "number")
            throw t6.$div();
          destRect = new P.Rectangle(t4, C.JSNumber_methods.toInt$0((t2 - t3) * 64 * t5 + t6 / 2), C.JSNumber_methods.toInt$0(64 * frame.scale), C.JSNumber_methods.toInt$0(64 * frame.scale));
          destRect.$builtinTypeInfo = [J.JSInt];
          t2 = frame.context;
          t3 = $.get$ImageLoader_images();
          J.drawImageToRect$2$x(t2, t3.$index(t3, "pathfinding-dot.png"), destRect);
        }
      }
    }
  },
  unitAt$2: function(x, y) {
    var t1, unit;
    for (t1 = this._mapObjects, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
      unit = t1._current;
      if (unit.get$tileX() === x && unit.tileY === y)
        return unit;
    }
    return;
  },
  TileMap$1: function(generator) {
    var t1;
    this._mapW = generator._mapWidth;
    this._mapH = generator._mapHeight;
    this._mapData = generator._data;
    t1 = $.get$ImageLoader_images();
    this._selectedTex = t1.$index(t1, "selected.png");
    t1 = $.get$ImageLoader_images();
    this._waypointTex = t1.$index(t1, "target.png");
    t1 = $.get$ImageLoader_images();
    this._waypointChooserTex = t1.$index(t1, "target_chooser.png");
    t1 = $.get$ImageLoader_images();
    this._pathfindingTex = t1.$index(t1, "pathfinding-dot.png");
    t1 = $.get$ImageLoader_images();
    this._tileset = t1.$index(t1, "tileset-1.png");
  },
  static: {
"": "TileMap_tileW,TileMap_tileH",
TileMap$: function(generator) {
  var t1 = P.List_List(null, F.Unit);
  H.setRuntimeTypeInfo(t1, [F.Unit]);
  t1 = new F.TileMap(null, null, null, t1, null, null, null, null, null);
  t1.TileMap$1(generator);
  return t1;
}}

},

Unit: {"": "PlayerAsset;tileX<",
  giveOrder$1: function(theOrder) {
    var t1, t2;
    window;
    t1 = $.get$Console__safeConsole();
    t2 = "Looky here unit at (" + this.tileX + "," + this.tileY + ") got a order";
    t1.toString;
    if (typeof console != "undefined")
      console.log(t2);
    this.orders.push(theOrder);
  },
  Unit$3: function(PlayerNumber, TileX, TileY) {
...
WayPoint: {"": "Object;_x,_y",
  ...
  $eq: function(_, comp) {
    ...
    if (comp == null)
      return false;
    t1 = J.getInterceptor$x(comp);
    return this._x === t1.get$x(comp) && this._y === t1.get$y(comp);
  }
},

AppState: {"": "Object;"},

InGameState: {"": "AppState;_turnState,_map,_turnNumber,_timeSinceLastTurn,_turnLength,_selectedUnits,_inOrderMode,_tempOrder,_tempOrderPath,_mouseZoom,_frame,_keyboard,fred,selectedUnit",
  _handleInput$1: function(delta) {
    var t1, t2, t3, t4, t5, t6, t7, t8, t9, o, clickX, clickY, clickedTileX, clickedTileY, scrollAmt;
    t1 = this._keyboard;
    if (t1.rDown && this.selectedUnit != null) {
      t2 = this._frame;
      t3 = t2.scrollX;
      t4 = t2.scale;
      t5 = t2.context.canvas;
      t6 = t5.width;
      if (typeof t6 !== "number")
        throw t6.$div();
      t7 = t1._x;
      ...
      if (typeof t8 !== "number")
        throw H.iae(t8);
      t9 = 64 * t4;
      o = new F.Order([new F.WayPoint(C.JSNumber_methods.toInt$0((t3 * 64 * t4 - t6 / 2 + t7) / t9), C.JSNumber_methods.toInt$0((t2 * 64 * t4 - t5 / 2 + t8) / t9))], null, this._map, false);
      t9 = this.selectedUnit;
      this._tempOrderPath = o.aStar$2(new F.WayPoint(t9.tileX, t9.tileY), o._waypoints[0]);
    } else
      this._tempOrderPath = null;
    if (t1._clickHappened) {
      window;
      ...
      window;
      t2 = $.get$Console__safeConsole();
      t4 = "screen loc " + H.S(t1._clickX) + ", " + H.S(t1._clickY);
      t2.toString;
      if (typeof console != "undefined")
        console.log(t4);
      t2 = t3.scrollX;
      t4 = t3.scale;
      t5 = t3.context.canvas;
      t6 = t5.width;
      if (typeof t6 !== "number")
        throw t6.$div();
      t7 = t1._clickX;
      ...
      if (typeof t6 !== "number")
        throw H.iae(t6);
      clickY = t7 * 64 * t4 - t5 / 2 + t6;
      window;
      t6 = $.get$Console__safeConsole();
      t5 = "clickPix " + H.S(clickX) + ", " + H.S(clickY);
      t6.toString;
      if (typeof console != "undefined")
        console.log(t5);
      t2 = 64 * t3.scale;
      clickedTileX = clickX / t2;
      clickedTileY = clickY / t2;
      window;
      t2 = $.get$Console__safeConsole();
      t3 = "click on " + H.S(clickedTileX) + ", " + H.S(clickedTileY);
      t2.toString;
      if (typeof console != "undefined")
        console.log(t3);
      this.selectedUnit = this._map.unitAt$2(C.JSNumber_methods.toInt$0(clickedTileX), C.JSNumber_methods.toInt$0(clickedTileY));
      t1._clickHappened = false;
    }
    if (t1._rClickHappened) {
      window;
      t2 = $.get$Console__safeConsole();
      t3 = this._frame;
      t4 = t3.scale;
      ...
      if (typeof console != "undefined")
        console.log(t5);
      t2 = 64 * t3.scale;
      t3 = this.selectedUnit;
      if (t3 != null)
        t3.giveOrder$1(new F.Order([new F.WayPoint(C.JSNumber_methods.toInt$0(clickX / t2), C.JSNumber_methods.toInt$0(clickY / t2))], null, this._map, false));
      t1._rClickHappened = false;
    }
    scrollAmt = J.$mul$n(delta, 0.01);
    if (t1.isKeyDown$1(87) === true) {
      t2 = this._frame;
      t3 = t2.scrollY;
      if (typeof scrollAmt !== "number")
        throw H.iae(scrollAmt);
      t2.scrollY = t3 - scrollAmt;
    }
    if (t1.isKeyDown$1(65) === true) {
      t2 = this._frame;
      t3 = t2.scrollX;
      if (typeof scrollAmt !== "number")
        throw H.iae(scrollAmt);
      t2.scrollX = t3 - scrollAmt;
    }
    if (t1.isKeyDown$1(83) === true) {
      t2 = this._frame;
      t3 = t2.scrollY;
      if (typeof scrollAmt !== "number")
        throw H.iae(scrollAmt);
    ...
    t2 = this._frame;
    t2.scrollTo$1(t2, t1._wheel);
  },
  static: {
"": "InGameState__scrollSpeed",
}

},

main_closure: {"": "Closure;",
  call$1: function(yolo) {
    var t1, t2;
    t1 = $.context;
    t2 = $.get$ImageLoader_images();
    t1.drawImage(t2.$index(t2, "target.png"), 200, 200);
  },
  $is_args1: true
},
...
main_closure0: {"": "Closure;",
  call$1: function(onValue) {
    return W.HttpRequest_getString("assets/tilemap.txt", null, null);
  },
  $is_args1: true
},

main_closure1: {"": "Closure;",
  call$1: function(mapData) {
    var t1, t2, t3;
    t1 = $.get$keyboard();
    t2 = F.FileMapGenerator$(mapData);
    t3 = P.List_List(null, F.Order);
    H.setRuntimeTypeInfo(t3, [F.Order]);
    t3 = new F.King(null, null, 0, 0, null, null, 1, 1000, 0, 0, 0, t3, null, new F.WayPoint(0, 0), null);
    t3.Unit$3(0, 0, 0);
    t3.myImagePlayerPrefix = "King";
    t3.tilesPerTurn = 1;
    t3 = new F.InGameState(0, null, 0, 0, 5, null, false, null, null, 0, new F.Frame(10, 10, 1, null), t1, t3, null);
    t3._map = F.TileMap$(t2);
    t3._map._mapObjects.push(t3.fred);
    $.state = t3;
    C.Window_methods.get$animationFrame(window).then$1(F.gameLoop$closure);
  },
  $is_args1: true
...
ListMixin: {"": "Object;",
  ...
  forEach$1: function(receiver, action) {
    ...
    for (t1 = $length !== receiver.length, i = 0; i < $length; ++i) {
  ...
  indexOf$2: function(receiver, element, startIndex) {
    ...
    if (startIndex < 0)
      startIndex = 0;
    for (t1 = receiver.length, t2 = receiver.length, i = startIndex; i < t1; ++i)
      if (i < 0 || i >= t2)
        throw H.ioore(receiver, i);
    return -1;
  },
...
CanvasElement: {"": "HtmlElement;", $isCanvasElement: true, "%": "HTMLCanvasElement"},
...
InputElement: {"": "HtmlElement;src}", $isElement: true, $isEventTarget: true, "%": "HTMLInputElement"},
...
Point: {"": "Object;x>,y>",
  ...
  $add: function(_, other) {
    var t1, t2, t3;
    t1 = J.$add$ns(this.x, C.JSNumber_methods.get$x(other));
    t2 = this.y;
    t3 = C.JSNumber_methods.get$y(other);
    if (typeof t2 !== "number")
      throw t2.$add();
    t3 = C.JSNumber_methods.$add(t2, t3);
    t3 = new P.Point(t1, t3);
...
init.globalFunctions.main$closure = F.main$closure = new F.Closure$0(F.main, "main$closure");
init.globalFunctions.gameLoop$closure = F.gameLoop$closure = new F.Closure$1(F.gameLoop, "gameLoop$closure");
...
init.globalFunctions.Primitives__throwFormatException$closure = H.Primitives__throwFormatException$closure = new F.Closure$1(H.Primitives__throwFormatException, "Primitives__throwFormatException$closure");
init.globalFunctions.toStringWrapper$closure = H.toStringWrapper$closure = new F.Closure$0(H.toStringWrapper, "toStringWrapper$closure");
init.globalFunctions.invokeClosure$closure = H.invokeClosure$closure = new H.Closure$7(H.invokeClosure, "invokeClosure$closure");
init.globalFunctions._asyncRunCallback$closure = P._asyncRunCallback$closure = new F.Closure$0(P._asyncRunCallback, "_asyncRunCallback$closure");
init.globalFunctions._nullDataHandler$closure = P._nullDataHandler$closure = new F.Closure$1(P._nullDataHandler, "_nullDataHandler$closure");
...
init.globalFunctions._nullDoneHandler$closure = P._nullDoneHandler$closure = new F.Closure$0(P._nullDoneHandler, "_nullDoneHandler$closure");
...
init.globalFunctions._defaultHashCode$closure = P._defaultHashCode$closure = new F.Closure$1(P._defaultHashCode, "_defaultHashCode$closure");
init.globalFunctions.identical$closure = P.identical$closure = new H.Closure$2(P.identical, "identical$closure");
init.globalFunctions.identityHashCode$closure = P.identityHashCode$closure = new F.Closure$1(P.identityHashCode, "identityHashCode$closure");
init.globalFunctions.Element__determineMouseWheelEventType$closure = W.Element__determineMouseWheelEventType$closure = new F.Closure$1(W.Element__determineMouseWheelEventType, "Element__determineMouseWheelEventType$closure");
...
F.Order.$isObject = true;
F.PathfindingNode.$isObject = true;
F.WayPoint.$isObject = true;
F.Unit.$isObject = true;
...
Isolate.$lazy($, "images", "ImageLoader_images", "get$ImageLoader_images", function() {
  return P.LinkedHashMap_LinkedHashMap(null, null, null, J.JSString, W.ImageElement);
});
Isolate.$lazy($, "filenames", "ImageLoader_filenames", "get$ImageLoader_filenames", function() {
  return ["target.png", "selected.png", "target.png", "target_chooser.png", "pathfinding-dot.png", "tileset-1.png", "PawnGreen.png", "PawnOrigional.png", "King.png", "KingGreen.png", "KingRed.png"];
});
Isolate.$lazy($, "keyboard", "keyboard", "get$keyboard", function() {
  return F.Keyboard$();
});
...
function dart_precompiled($collectedClasses) {
  ...
  function FileMapGenerator(_mapWidth, _mapHeight, _data) {
    this._mapWidth = _mapWidth;
    this._mapHeight = _mapHeight;
    this._data = _data;
  }
  FileMapGenerator.builtin$cls = "FileMapGenerator";
  if (!"name" in FileMapGenerator)
    FileMapGenerator.name = "FileMapGenerator";
  $desc = $collectedClasses.FileMapGenerator;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FileMapGenerator.prototype = $desc;
  function Frame(scrollX, scrollY, scale, context) {
  ...
  function Keyboard(_wheel, _keyMap, _clickHappened, _rClickHappened, _clickX, _clickY, _rClickX, _rClickY, _x, _y, rDown) {
    this._wheel = _wheel;
    this._keyMap = _keyMap;
    this._clickHappened = _clickHappened;
    this._rClickHappened = _rClickHappened;
    this._clickX = _clickX;
    this._clickY = _clickY;
    this._rClickX = _rClickX;
    this._rClickY = _rClickY;
    this._x = _x;
    this._y = _y;
    this.rDown = rDown;
  }
  ...
  function Keyboard_closure0(this_1) {
    this.this_1 = this_1;
  }
  Keyboard_closure0.builtin$cls = "Keyboard_closure0";
  if (!"name" in Keyboard_closure0)
    Keyboard_closure0.name = "Keyboard_closure0";
  $desc = $collectedClasses.Keyboard_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Keyboard_closure0.prototype = $desc;
  function Keyboard_closure1(this_2) {
    this.this_2 = this_2;
  }
  Keyboard_closure1.builtin$cls = "Keyboard_closure1";
  if (!"name" in Keyboard_closure1)
    Keyboard_closure1.name = "Keyboard_closure1";
  $desc = $collectedClasses.Keyboard_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Keyboard_closure1.prototype = $desc;
  function Keyboard_closure2(this_3) {
    this.this_3 = this_3;
  }
  Keyboard_closure2.builtin$cls = "Keyboard_closure2";
  if (!"name" in Keyboard_closure2)
    Keyboard_closure2.name = "Keyboard_closure2";
  $desc = $collectedClasses.Keyboard_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Keyboard_closure2.prototype = $desc;
  function Keyboard_closure3(this_4) {
    this.this_4 = this_4;
  }
  Keyboard_closure3.builtin$cls = "Keyboard_closure3";
  if (!"name" in Keyboard_closure3)
    Keyboard_closure3.name = "Keyboard_closure3";
  $desc = $collectedClasses.Keyboard_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Keyboard_closure3.prototype = $desc;
  function Keyboard_closure4(this_5) {
    this.this_5 = this_5;
  }
  Keyboard_closure4.builtin$cls = "Keyboard_closure4";
  if (!"name" in Keyboard_closure4)
    Keyboard_closure4.name = "Keyboard_closure4";
  $desc = $collectedClasses.Keyboard_closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Keyboard_closure4.prototype = $desc;
  function Keyboard_closure5(this_6) {
    this.this_6 = this_6;
  }
  Keyboard_closure5.builtin$cls = "Keyboard_closure5";
  if (!"name" in Keyboard_closure5)
    Keyboard_closure5.name = "Keyboard_closure5";
  $desc = $collectedClasses.Keyboard_closure5;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Keyboard_closure5.prototype = $desc;
  function Keyboard_closure6(this_7) {
    this.this_7 = this_7;
  }
  Keyboard_closure6.builtin$cls = "Keyboard_closure6";
  if (!"name" in Keyboard_closure6)
    Keyboard_closure6.name = "Keyboard_closure6";
  $desc = $collectedClasses.Keyboard_closure6;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Keyboard_closure6.prototype = $desc;
  function King(tileX, tileY, offsetX, offsetY, myImagePlayerSufix, myImagePlayerPrefix, tilesPerTurn, timePerTile, tilesMovedAlready, msAlreadyAnimated, currentUnitTurnState, orders, currentOrder, currentMovingToPoint, _player) {
    this.tileX = tileX;
    this.tileY = tileY;
    this.offsetX = offsetX;
    this.offsetY = offsetY;
    this.myImagePlayerSufix = myImagePlayerSufix;
    this.myImagePlayerPrefix = myImagePlayerPrefix;
    this.tilesPerTurn = tilesPerTurn;
    this.timePerTile = timePerTile;
    this.tilesMovedAlready = tilesMovedAlready;
    this.msAlreadyAnimated = msAlreadyAnimated;
    this.currentUnitTurnState = currentUnitTurnState;
    this.orders = orders;
    this.currentOrder = currentOrder;
    this.currentMovingToPoint = currentMovingToPoint;
    this._player = _player;
  }
  King.builtin$cls = "King";
  if (!"name" in King)
    King.name = "King";
  $desc = $collectedClasses.King;
  if ($desc instanceof Array)
    $desc = $desc[1];
  King.prototype = $desc;
  function MapLoader() {
  ...
  function Order(_waypoints, _turnsTillExecute, _map, activated) {
    this._waypoints = _waypoints;
    this._turnsTillExecute = _turnsTillExecute;
    this._map = _map;
    this.activated = activated;
  }
  Order.builtin$cls = "Order";
  if (!"name" in Order)
    Order.name = "Order";
  $desc = $collectedClasses.Order;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Order.prototype = $desc;
  function PathfindingNode(_waypoint, scored, totalScore, pastScore) {
    this._waypoint = _waypoint;
    this.scored = scored;
    this.totalScore = totalScore;
    this.pastScore = pastScore;
  }
  PathfindingNode.builtin$cls = "PathfindingNode";
  if (!"name" in PathfindingNode)
    PathfindingNode.name = "PathfindingNode";
  $desc = $collectedClasses.PathfindingNode;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PathfindingNode.prototype = $desc;
  function PlayerAsset() {
  }
  PlayerAsset.builtin$cls = "PlayerAsset";
  if (!"name" in PlayerAsset)
    PlayerAsset.name = "PlayerAsset";
  $desc = $collectedClasses.PlayerAsset;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PlayerAsset.prototype = $desc;
  function TileMap(_mapW, _mapH, _mapData, _mapObjects, _selectedTex, _waypointTex, _waypointChooserTex, _pathfindingTex, _tileset) {
    this._mapW = _mapW;
    this._mapH = _mapH;
    this._mapData = _mapData;
    this._mapObjects = _mapObjects;
    this._selectedTex = _selectedTex;
    this._waypointTex = _waypointTex;
    this._waypointChooserTex = _waypointChooserTex;
    this._pathfindingTex = _pathfindingTex;
  ...
  Unit.builtin$cls = "Unit";
  if (!"name" in Unit)
    Unit.name = "Unit";
  $desc = $collectedClasses.Unit;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Unit.prototype = $desc;
  Unit.prototype.get$tileX = function() {
    return this.tileX;
  };
  ...
  WayPoint.builtin$cls = "WayPoint";
  if (!"name" in WayPoint)
    WayPoint.name = "WayPoint";
  $desc = $collectedClasses.WayPoint;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WayPoint.prototype = $desc;
  function AppState() {
  }
  AppState.builtin$cls = "AppState";
  if (!"name" in AppState)
    AppState.name = "AppState";
  $desc = $collectedClasses.AppState;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AppState.prototype = $desc;
  function InGameState(_turnState, _map, _turnNumber, _timeSinceLastTurn, _turnLength, _selectedUnits, _inOrderMode, _tempOrder, _tempOrderPath, _mouseZoom, _frame, _keyboard, fred, selectedUnit) {
    this._turnState = _turnState;
    this._map = _map;
    this._turnNumber = _turnNumber;
    this._timeSinceLastTurn = _timeSinceLastTurn;
    this._turnLength = _turnLength;
    this._selectedUnits = _selectedUnits;
    this._inOrderMode = _inOrderMode;
    this._tempOrder = _tempOrder;
    this._tempOrderPath = _tempOrderPath;
    this._mouseZoom = _mouseZoom;
    this._frame = _frame;
    this._keyboard = _keyboard;
    this.fred = fred;
    this.selectedUnit = selectedUnit;
  }
  InGameState.builtin$cls = "InGameState";
  if (!"name" in InGameState)
    InGameState.name = "InGameState";
  $desc = $collectedClasses.InGameState;
  if ($desc instanceof Array)
    $desc = $desc[1];
  InGameState.prototype = $desc;
